---
title: "Exploratory Data Analysis - Spring 2019"
...
In order to evaluate the data, we must first set the working directory and import the data using the `r read.csv` function.
...
Once this data is imported, we look to the summary of the data using both the `r str` function, which shows us the types of data characters in each column, and `r summary` function, which shows the number of values and the quartiles.
